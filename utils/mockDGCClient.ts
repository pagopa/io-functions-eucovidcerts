...
const aMockedRequestWithRightParams: r.TypeofApiResponse<GetCertificateByAutAndCFT> = {
  headers: {},
  status: 200,
  value: mockQRCodeInfo
};

export const mockGetCertificateByAutAndCF: DGCClient["getCertificateByAutAndCF"] = async _body =>
  E.right(aMockedRequestWithRightParams);
