...
export const fakeQRCodeInfo: SearchSingleQrCodeResponseDTO = {
  data: {
...
const fakeGetCertificateByAutAndCF: DGCClient["getCertificateByAutAndCF"] = async _body =>
  E.right({
    headers: {},
    status: 200,
    value: fakeQRCodeInfo
  });

const fakeManagePreviousCertificates: DGCClient["managePreviousCertificates"] = async _body =>
  E.right({
    headers: {},
    status: 200,
    value: {
...
export const fakeClient = {
  ...
  getCertificateByAutAndCF: fakeGetCertificateByAutAndCF,
  managePreviousCertificates: fakeManagePreviousCertificates
};
